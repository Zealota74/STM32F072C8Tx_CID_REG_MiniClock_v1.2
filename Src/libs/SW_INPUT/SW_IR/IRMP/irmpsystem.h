...
// Simon --------------------
#elif defined(STM32F303xE) || defined(STM32F303xC)                                                           // ARM STM32
#  include <stm32f3xx.h>
#  define ARM_STM32
#  define ARM_STM32F3XX
#elif defined(STM32F103xB)                                                            // ARM STM32
#  include <stm32f1xx.h>
#  define ARM_STM32
#  define ARM_STM32F1XX
#elif defined(STM32F072xB)                                                            // ARM STM32
#  include <stm32f0xx.h>
#  define ARM_STM32
